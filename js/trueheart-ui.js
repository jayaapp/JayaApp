...
class TrueHeartUI {
    ...
    getLocalizedMessage(key) {
        ...
        if (window.localeData && window.localeData[currentLang] && window.localeData[currentLang][key]) {
            // Convert escaped newlines to actual newlines for prompts/confirms
                ...
                <div class="trueheart-account-view" id="trueheart-account-view" style="display: none;">
                    ...
                    <div class="trueheart-sync-controls">
                        <button class="trueheart-btn-sync" id="trueheart-sync-btn">
                            <i class="material-symbols-outlined" id="trueheart-sync-icon">cloud_sync</i>
    ...
    attachEventListeners() {
        ...
        donateLink?.addEventListener('click', (e) => {
            e.preventDefault();
            // Trigger the donate-toggle button to open donation panel
            const donateToggle = document.getElementById('donate-toggle');
            if (donateToggle) {
                donateToggle.click();
            } else {
                // Fallback if donate button not found
